<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
          ...
          <input required  type="email" class="form-control" value="<?php echo $empleado->correo; ?>" name="correo" id="correo" aria-describedby="emailHelpId" placeholder="Correo del empleado">
